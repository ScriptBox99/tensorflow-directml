...
class DmlCropAndResizeGradBoxesKernel : public DmlKernel {
 public:
  ...
  explicit DmlCropAndResizeGradBoxesKernel(DmlKernelConstruction* ctx,
    ...
    auto result = dml::RoiAlignRoiGrad(
        input_gradient, image, roi, batch_indices, DML_REDUCE_FUNCTION_AVERAGE,
        ...
        maximum_samples_per_output, align_region_to_corners);
    ...
    result = dml::Reinterpret(result, {1, roi_sizes[2], 2, 2}, {});
